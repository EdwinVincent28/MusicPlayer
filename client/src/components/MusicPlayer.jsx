		...
		<div className="fixed bottom-0 left-0 right-0 z-50 bg-zinc-900/80 backdrop-blur-2xl border-t border-white/5 px-6 py-4 flex items-center justify-between gap-4">
			...
			<div className="flex items-center gap-4 w-64 shrink-0">
				<div className="relative shrink-0">
					<img
						src="https://picsum.photos/seed/track1/56/56"
						alt="Now Playing"
				...
				<div className="min-w-0">
					...
					<p className="text-zinc-500 text-xs mt-0.5 truncate">The Weeknd</p>
				</div>
				<button
			...
			<div className="flex flex-col items-center gap-2 flex-1 max-w-xl">
				<div className="flex items-center gap-5">
					...
					<button
						...
						className="w-11 h-11 rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-600 place-items-center justify-center shadow-lg shadow-violet-900/60 hover:scale-105 active:scale-95 transition-transform duration-150"
					>
						{playing ? (
				...
				<div className="flex items-center gap-3 w-full">
					...
					/>
					<span className="text-zinc-600 text-xs w-8 shrink-0">4:02</span>
				</div>
			</div>
