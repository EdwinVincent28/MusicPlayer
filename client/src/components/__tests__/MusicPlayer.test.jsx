...
describe("MusicPlayer", () => {
	test("renders player with track info", async () => {
		setupPlayer();
		await act(async () => {
			render(<MusicPlayer />);
		});
	...
	test("toggles play button", async () => {
		setupPlayer();
		await act(async () => {
			render(<MusicPlayer />);
		});
	...
	test("calls skip previous", async () => {
		setupPlayer();
		await act(async () => {
			render(<MusicPlayer />);
		});
	...
	test("changes progress slider", async () => {
		setupPlayer();
		await act(async () => {
			render(<MusicPlayer />);
		});
	...
	test("changes volume slider", async () => {
		setupPlayer();
		await act(async () => {
			render(<MusicPlayer />);
		});
	...
	test("fetches liked status on mount", async () => {
		setupPlayer();
		axios.get.mockResolvedValue({ data: { isLiked: true } });
	...
	test("shows no preview message when preview missing", async () => {
		setupPlayer({ currentTrack: { ...mockTrack, preview: null } });
